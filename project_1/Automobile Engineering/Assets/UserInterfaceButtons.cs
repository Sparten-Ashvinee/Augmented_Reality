...
//	public GameObject Model;
	...
	public void RotationRightButton ()
	{
        ...
        GameObject.FindWithTag("Model9").transform.Rotate(0, -rotationSpeed * Time.deltaTime, 0);
        GameObject.FindWithTag("Model10").transform.Rotate(0, -rotationSpeed * Time.deltaTime, 0);
	}
